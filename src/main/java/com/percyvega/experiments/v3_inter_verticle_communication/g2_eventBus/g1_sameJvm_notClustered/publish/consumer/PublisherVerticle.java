package com.percyvega.experiments.v3_inter_verticle_communication.g2_eventBus.g1_sameJvm_notClustered.publish.consumer;
...
public class PublisherVerticle extends AbstractVerticle {
    ...
    public static void main(String[] args) {
        ...
        vertx.deployVerticle(new Consumer1Verticle(), res -> {
            if(res.succeeded()){
        ...
        vertx.deployVerticle(new Consumer2Verticle(), res -> {
            if(res.succeeded()){
                log.info("Deployment id is: " + res.result());
            } else {
                log.error("Deployment failed!");
