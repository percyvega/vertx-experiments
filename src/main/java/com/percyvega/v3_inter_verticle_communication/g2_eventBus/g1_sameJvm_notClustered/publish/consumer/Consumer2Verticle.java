package com.percyvega.v3_inter_verticle_communication.g2_eventBus.g1_sameJvm_notClustered.publish.consumer;
...
import static com.percyvega.v3_inter_verticle_communication.g2_eventBus.g1_sameJvm_notClustered.send.consumer.SenderVerticle.ADDRESS;

public class Consumer2Verticle extends AbstractVerticle {
    private static final Logger log = LogManager.getLogger(Consumer2Verticle.class.getName());
