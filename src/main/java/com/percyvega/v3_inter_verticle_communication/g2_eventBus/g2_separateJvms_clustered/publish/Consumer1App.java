package com.percyvega.v3_inter_verticle_communication.g2_eventBus.g2_separateJvms_clustered.publish;
...
public class Consumer1App extends AbstractVerticle {

    private static final Logger log = LogManager.getLogger(Consumer1App.class.getName());

    public static void main(String[] args) {
        log.info("*********************************************************** Running main() from " + Consumer1App.class.getSimpleName());
        ...
        Vertx.clusteredVertx(vertxOptions, resultHandler -> {
            if (resultHandler.succeeded()) {
                ...
                vertx.deployVerticle(new Consumer1App());
            }
        });
    }
